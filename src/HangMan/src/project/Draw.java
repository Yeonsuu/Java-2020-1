...
class Draw extends JPanel{
	...
	public void DrawHangMan(Graphics g) {
		Image head= Toolkit.getDefaultToolkit().getImage("머리.png");  
		Image body= Toolkit.getDefaultToolkit().getImage("몸통1.png");
		Image left_A= Toolkit.getDefaultToolkit().getImage("왼팔.png");
		Image right_A= Toolkit.getDefaultToolkit().getImage("오른팔.png");
		Image left_L= Toolkit.getDefaultToolkit().getImage("왼발.png");
		Image right_L= Toolkit.getDefaultToolkit().getImage("오른발.png");
